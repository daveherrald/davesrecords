...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 p-4">
      <main className="flex max-w-4xl flex-col items-center justify-center space-y-8 text-center">
        ...
        <div className="grid max-w-3xl gap-8 pt-16 sm:grid-cols-3">
